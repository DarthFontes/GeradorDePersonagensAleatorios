...
function generateNPC() {
    ...
    const dados = sistemas["Tormenta 20"];

    let names = dados.names;
    let classes = dados.classes;
    let race = dados.race;
    let deuses = dados.deuses;
    let origem = dados.origem;
    let trejeitos = dados.trejeitos;
    let aparencia = dados.aparencia;
    let backgrounds = dados.backgrounds;
